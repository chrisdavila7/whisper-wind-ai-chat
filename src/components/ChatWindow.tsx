...
const ChatWindow = () => {
  ...
  return <div className="flex flex-col h-full max-h-full rounded-15">
      ...
      <div className="flex justify-end items-center p-4 backdrop-blur-sm rounded-t-15 border-gray-500 border-t-4">
      ...
      <div className="p-4 bg-gray-50/20 border-t border-gray-500 rounded-b-15 border-l-2 border-b-2 border-r-2">
