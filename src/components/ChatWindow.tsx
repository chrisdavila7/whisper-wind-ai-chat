...
const ChatWindow = () => {
  ...
  return <div className="flex flex-col h-full max-h-full rounded-15">
      ...
      <div className="flex-1 overflow-y-auto p-4 border-gray-500 border-l-2 border-r-2 border border-b-rounded-15 my-0 mx-0 px-0 py-[32px] rounded-lg">
        {messages.length === 0 ? <div className="h-full flex flex-col items-center justify-center text-center p-8 backdrop-blur-md \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\nrounded-15 bg-white/0 border-15 mx-[26px] py-px my-[2px] rounded-xl">
      ...
      <div className="p-4 border-t border-gray-500 rounded-b-15 border-l-2 border-b-2 border-r-2 my-0 py-[16px]">
