...
const ChatWindow = () => {
  ...
  return <div className="flex flex-col h-full max-h-full rounded-15">
      ...
      <div className="flex justify-end items-center p-4 backdrop-blur-sm rounded-t-15 border-gray-500 border-t-2 border-l-2 border-r-2 mt-15">
      ...
      <div className="flex-1 overflow-y-auto p-4 backdrop-blur-sm border-gray-500 border-l-2 border-r-2 border-b-1">
        {messages.length === 0 ? <div className="h-full flex flex-col items-center justify-center text-center p-8 backdrop-blur-3xl rounded-15 bg-white/0">
