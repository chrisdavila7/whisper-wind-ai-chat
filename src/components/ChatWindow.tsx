...
const ChatWindow = () => {
  ...
  return <div className="flex flex-col h-full max-h-full rounded-15 my-[-40px]">
      ...
      <div className="flex-1 overflow-y-auto p-4 border-gray-500 border-l-2 border-r-2 border-b-2 rounded-b-15 border-t-2 rounded-t-15 mt-[25px] mb-[120px] pb-[20px] pt[20px]">
