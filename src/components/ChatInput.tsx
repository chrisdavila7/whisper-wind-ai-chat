...
const ChatInput = ({
  ...
  return <form onSubmit={handleSubmit} className="flex items-center gap-2 w-full bg-white/20 backdrop-blur-3xl rounded-15 p-2 shadow-md border border-white/20">
      ...
      {isLoading ? <Button onClick={onStopGeneration} type="button" variant="outline" size="icon" className="text-gray-500 hover:text-red-500 bg-white/30 rounded-15">
        ...
        </Button> : <Button type="submit" disabled={!inputValue.trim()} size="icon" className="bg-ai-primary/80 hover:bg-ai-secondary/80 text-white rounded-15">
