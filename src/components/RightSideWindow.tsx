...
const RightSideWindow = ({
  ...
  return (
    ...
    >
      <div className="flex-1 overflow-y-auto p-4 border-gray-500 border-l-4 border-r-4 border-b-4 rounded-b-15 border-t-4 rounded-t-15 h-full bg-white/10 backdrop-blur-md mx-4 sm:mx-8 md:mx-6 relative">
