    ...
    <div 
      ...
      style={{
        background: theme === 'dark' 
          ? 'radial-gradient(ellipse at center, #131b2e 0%, #0a1428 50%, #79a1ff 100%)' 
          : 'radial-gradient(ellipse at center, #d6bcfa 0%, #e5deff 50%, #79a1ff 100%)',
        backgroundSize: '400% 400%',
        animation: 'radialPulse 5s ease infinite'
      }}
    >
      <canvas 
        ref={canvasRef}
