      ...
      <div 
        ...
        style={{
          background: theme === 'dark' 
            ? 'linear-gradient(170deg, #ccccff 10%, #ccccff 20%, #ccccff 10%, #0d1117, #0d1117, #0d1117, #0d1117)'
            : 'linear-gradient(170deg, #33C3F0 10%, #accbee 20%, #e7f0fd 40%, #d3e4fd 60%, #f1f0fb 80%, #f1f0fb 80%, #ffffff 100%)',
